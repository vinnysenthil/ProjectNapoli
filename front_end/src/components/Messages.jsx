  ...
  class Profile extends Component {
    ...
    render() {
      ...
      return (
        <div>
          <Header as="h1">
            <Icon name="mail outline" /> My Messages
          </Header>
          ...
          {this.state.messages && (
            <div>
              <p>
                This component makes a GET request to the resource server
                example, which must be running at{" "}
                <code>localhost:8000/api/messages</code>
              </p>
              <p>
                It attaches your current access token in the{" "}
                <code>Authorization</code> header on the request, and the
                resource server will attempt to authenticate this access token.
                If the token is valid the server will return a list of messages.
                If the token is not valid or the resource server is incorrectly
                configured, you will see a 401{" "}
              ...
              <p>
                ...
                and have an access token in local storage.
              </p>
              <Table>
                <thead>
                  <tr>
